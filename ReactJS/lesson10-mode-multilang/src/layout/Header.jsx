        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <div className="modal-body">
                    ...
                    <ul className="list-group">
                      {!keyword
                        ...
                        : product
                            .filter((p) =>
                              p.title.toLocaleLowerCase().includes(keyword)
                            )
                            .map((item, index) => (
                              <span data-bs-dismiss="modal" key={index}>
                                <Link
          ...
          <div>
            <button onClick={()=>{
              ...
              document.querySelector('html').attributes[1].value=`${mode}`;
            }} className="btn btn-warning ms-3" style={{textTransform:"uppercase"}}>{mode}</button>
          </div>
        </div>
      </div>
    </nav>
